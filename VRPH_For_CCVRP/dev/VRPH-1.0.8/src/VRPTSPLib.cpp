...
const char *SupportedTSPLIBStrings[]={
    ...
    // 24
    "COORD_DISPLAY", "TOUR_LENGTH", "CLUSTER_SECTION"}; // M.CISSE ->before : | "COORD_DISPLAY"}; |
...
const int SL[]={4,4,10,9,
                ...
                8,16,19,7,
                20,12,17,10,
                13, 11, 15}; // M.CISSE ->before : | 13}; |

// Simply the number of supported strings
const int NumSupportedTSPLIBStrings = 27;  // M.CISSE  ->before : | const int NumSupportedTSPLIBStrings = 25; |
