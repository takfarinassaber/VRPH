...
{
    printf("--------------------------------------------\n");
    printf("VRPH, version 1.0.8\n");
    printf("Copyright 2010 Chris Groer\n");
    /*
    printf("Contributors : Cissé Mohamed 2012\n");
    printf("               Saber Takfarinas 2012\n");
    */
    printf("Distributed under Common Public License 1.0\n");
    printf("--------------------------------------------\n\n");
}
...
bool VRP::get_has_cluster(){
  ///
  /// Returns true if th problem is a CCVRP problem
  ///
  return this->has_cluster;
}


int VRP::get_cluster_success(){
  ///
  /// Returns 0 if the solution of the CCVRP problem is consistent. Otherwese returns 1
  /// It can be very useful to return this value at the end of the main program
  ///
  return this->cluster_success;
}
